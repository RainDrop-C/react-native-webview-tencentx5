...
var RNX5WebView = requireNativeComponent('RNX5WebView');
...
var WebView = /** @class */ (function (_super) {
    ...
    function WebView() {
        ...
        _this.getCommands = function () { return UIManager.getViewManagerConfig('RNX5WebView').Commands; };
        ...
        _this.onShouldStartLoadWithRequestCallback = function (shouldStart, url, lockIdentifier) {
            if (lockIdentifier) {
                NativeModules.RNX5WebView.onShouldStartLoadWithRequestCallback(shouldStart, lockIdentifier);
            }
            else if (shouldStart) {
    ...
    WebView.prototype.render = function () {
        ...
        if (this.state.viewState === 'LOADING') {
            ...
            console.error("RNX5WebView invalid state encountered: " + this.state.viewState);
        }
        ...
        var NativeWebView = nativeConfig.component || RNX5WebView;
    ...
    WebView.isFileUploadSupported = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, NativeModules.RNX5WebView.isFileUploadSupported()];
        });
    }); };
    return WebView;
}(React.Component));
